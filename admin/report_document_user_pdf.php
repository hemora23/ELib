...
$id            = isset($_GET['id']) ?  $_GET['id'] : '';
$mySql        = "SELECT user_fullname FROM master_user WHERE user_id='$id'";
$myQry        = mysqli_query($koneksidb, $mySql)  or die("RENTAS ERP ERROR : " . mysqli_error($koneksidb));
$myData     = mysqli_fetch_array($myQry);
$doctitleid    = $id . ' ' . $myData['user_fullname'];
$doctitleid = str_replace('%', 'All User', $doctitleid);
...
$pdf->Ln();
$pdf->Cell(190, 4, 'User :  ' . $doctitleid, '', 0, 'C', 0);
$pdf->Ln();
$pdf->Ln();
...
$mySqlDtl     = "SELECT * FROM view_log_document_peruser WHERE tgl between '$tgl1' and '$tgl2' and user_id like '$id'
