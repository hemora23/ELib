...
<!--/ header --> 
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            ...
            <div class="navbar nav_title " style="border: 0; background-color:#CCCCCC; padding-top:10px" >
                  ...
                  <li><a><i class="fa fa-bar-chart"></i> Statistic<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">                      
                      ...
                      <li><a>Documents<span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">   
                          ...
                          <li><a href="?page=Report-Document-Div">By Division/Dept.</a></li>
                   ...
                   <li><a><i class="fa fa-file-text-o"></i> Report<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu"> 
                      ...
                      <li><a href="?page=Report-Doc">Laporan dokumen yang telah dilihat oleh karyawan</a></li>
                      <li><a href="?page=Report-Div">Laporan dokumen per divisi</a></li>
                    </ul>
                  </li>
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src=<?php echo "../uploads/user/".$_SESSION['SES_PHOTO'];?> alt=""><?php echo $_SESSION['SES_NAMA'];?>
                    <span class=" fa fa-angle-down"></span>
                  </a>
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    <li><a href="?page=Profile"><i class="fa fa-user pull-right"></i> Profile</a></li>
                    <li><a href="../uploads/Rentas_KMS_user_guide.pdf" ><i class="fa fa-book pull-right"></i> User Guide</a></li>
                ...
                <?php
				$ses_nama	= $_SESSION['SES_NAMA'];
				$mySql 	= "SELECT count(*) as total FROM view_document WHERE (document_status='Revised') and updated_by <>'$ses_nama' ";
				...
				(SELECT count(*) as tot FROM view_document WHERE (document_status='Created' or document_status='Updated' or document_status='Request Delete') and updated_by <>'$ses_nama' 
                ...
                <li role="presentation" class="dropdown">
                  <a href="javascript:;" class="dropdown-toggle info-number" data-toggle="dropdown" aria-expanded="false">
                    ...
                    <span class="badge bg-green"><?php echo $TotalApproval; ?></span>
                  </a>
                  <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                    <li>
