...
if(isset($_POST['btnSubmit'])){
	...
	if (count($pesanError)>=1 ){
		...
		$mySql  	= "UPDATE master_status SET status_name='$txtStatus', status_group='$txtGroup', updated_by='$ses_nama'   , updated_date=now() WHERE status_id = '$kode'";
...
$mySql	= "SELECT * FROM master_status WHERE status_id='$Code'";
$myQry	= mysqli_query($koneksidb,$mySql)  or die ("Query ambil data salah : ".mysqli_error());
$myData = mysqli_fetch_array($myQry);
# MASUKKAN DATA KE VARIABEL

$dataStatus	= isset($_POST['txtStatus']) ? $_POST['txtStatus'] : $myData['status_name'];
$dataGroup	= isset($_POST['txtGroup']) ? $_POST['txtGroup'] : $myData['status_group'];
