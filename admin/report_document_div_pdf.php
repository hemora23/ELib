...
$pdf->Ln();
$pdf->Cell(190, 4, 'Division / department :  ' . str_replace('%', 'All Division', $id) . ' / ' . str_replace('%', 'All Department', $id2), '', 0, 'C', 0);
$pdf->Ln();
$pdf->Ln();
...
$mySqlDtl     = "SELECT * FROM view_log_document_perdivision WHERE tgl between '$tgl1' and '$tgl2' and division like '$id' 
