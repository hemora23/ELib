...
include "header.php";
$_SESSION['SES_PAGE'] = "?page=Wallpaper";
?>
<!-- page content -->
  ...
  <div class="">
    <div class="page-title">
      <div class="title_left">
        <h3>Upload Wallpaper<small></small></h3>
      </div>
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            <div class="col-xs-6">
              <h4>upload wallpaper ( .jpg / min 1600 x 1200 )</h4>
              <form action="upload_wallpaper.php" class="dropzone">
            ...
            <div class="col-xs-6">
              <h4>Files (<a href="?page=Wallpaper" role="button"><i class="fa fa-undo fa-fw"></i> <u>Refresh</u></a>)</h4>
              <table id="datatable-responsive-x" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                ...
                <tbody>
                  ...
                  <?php
                  $mySql   = "SELECT * FROM master_wallpaper ";
                  ...
                  ?>
                    ...
                    <tr>
                      <td>
                        <img src="../uploads/wallpaper.jpg" width="100%" />
                        <br /><br />
