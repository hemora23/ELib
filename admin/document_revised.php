<?php
$_SESSION['SES_TITLE'] = "Revised Document";
include_once "library/inc.seslogin.php";
include "header.php";
$_SESSION['SES_PAGE']="?page=Document-Revised";
?>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Revised Documents<small></small></h3>
              </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content table-responsive">                    
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive" cellspacing="0" width="100%">
									...
									$mySql 	= "SELECT * FROM view_document where document_status='Revised' order  by updated_date desc";
									...
									?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $myData['document_note']; ?></td>
                                            <td><?php echo $Category; ?></td>
                                            
                                            <td>
                                            <?php if ($myData['document_status']!='Reviewed') {?>
                                            <a href="?page=Document-Edit&id=<?php echo $Code; ?>&v=<?php echo $Version; ?>" target="_self" alt="Edit Data"><i class="fa fa-edit fa-fw"></i> Revisi</a>
                                            <?php } ?>
                                            </td>
