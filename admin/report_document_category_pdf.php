...
category_level_5, category_level_6 FROM master_category where category_id='$id' group by category_id order by category_id";
...
while ($row = mysqli_fetch_array($result)) {
    ...
    $category = $row['category_level_1'] . ' ' . $dataCategory2 . ' ' . $dataCategory3 . ' ' . $dataCategory4 . ' ' . $dataCategory5 . ' ' . $dataCategory6;
}
if ($id == '%') {
...
$pdf->Ln();
$pdf->Cell(190, 4, 'Category :  ' . $category, '', 0, 'C', 0);
$pdf->Ln();
$pdf->Ln();
...
$mySqlDtl     = "SELECT * FROM view_log_document_percategory WHERE tgl between '$tgl1' and '$tgl2' and category_id like '$id'
ORDER BY tgl, document_id, document_version ";
