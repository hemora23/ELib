<?php
$_SESSION['SES_TITLE'] = "Statistic of document by document ";
...
$title	= isset($_GET['t']) ?  $_GET['t'] : 'Report of document by document'; 
$_SESSION['SES_SUBTITLE'] = "Document : ".$id." & date : ".$tgl1." - ".$tgl2;
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Statistic of Documents<small> ( By Document )</small></h3>
              </div>
                ...
                <div class="x_panel">
                  ...
                  <form  role="form" action="?page=Filter" method="POST" name="form1" target="_self" id="form1"> 
                    ...
                    <div class="col-sm-2">
                       <div class="form-group">
                       		<label>&nbsp;</label><br />
                            <button type="submit" class="btn btn-primary btn-sm" name="btnDocumentDoc" style="width:100%"><i class="fa fa-filter fa-fw"></i> Filter</button>
                    	</div>
                    </div>
                    <div class="col-sm-2">
                       <div class="form-group">
                       		<label>&nbsp;</label><br />
                            <button type="submit" class="btn btn-info btn-sm" name="btnDocumentDocSubmit" style="width:100%"><i class="fa fa-file-pdf-o fa-fw"></i> PDF</button>
                  ...
                  <div class="x_content table-responsive">                    
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
									...
									$id	= isset($_GET['id']) ?  $_GET['id'] : '%'; 
									$mySql 	= "SELECT * FROM view_log_document_perdate WHERE tgl between '$tgl1' and '$tgl2' and document_id like '$id'
									ORDER BY tgl, document_id";
