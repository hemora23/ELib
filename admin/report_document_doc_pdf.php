...
$pdf->Ln();
$pdf->Cell(190, 4, 'Document :  ' . $doctitleid, '', 0, 'C', 0);
$pdf->Ln();
$pdf->Ln();
...
$mySqlDtl     = "SELECT * FROM view_log_document_perdate WHERE tgl between '$tgl1' and '$tgl2' and document_id like '$id'
