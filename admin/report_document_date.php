<?php
$_SESSION['SES_TITLE'] = "Statistic of document by date ";
...
$_SESSION['SES_PAGE'] = "?page=Report-Document-Date&fr=".$tgl1."&to=".$tgl2; 
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Statistic of Documents<small> ( By Date )</small></h3>
              </div>
                ...
                <div class="x_panel">
                  ...
                  <form  role="form" action="?page=Filter" method="POST" name="form1" target="_self" id="form1"> 
                    ...
                    <div class="col-sm-2">
                       <div class="form-group">
                       		<label>&nbsp;</label><br />
                            <button type="submit" class="btn btn-primary btn-sm" name="btnDocumentDate" style="width:100%"><i class="fa fa-filter fa-fw"></i> Filter</button>
                    	</div>
                    </div>
                    <div class="col-sm-2">
                       <div class="form-group">
                       		<label>&nbsp;</label><br />
                            <button type="submit" class="btn btn-info btn-sm" name="btnDocumentDateSubmit" style="width:100%"><i class="fa fa-file-pdf-o fa-fw"></i> PDF</button>
                  ...
                  <div class="x_content table-responsive">                    
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                    ...
                                    $mySql 	= "SELECT * FROM view_log_document_perdate WHERE tgl between '$tgl1' and '$tgl2' ORDER BY tgl ";
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo date_format(new DateTime($myData['tgl']),"d M Y"); ?></td>
