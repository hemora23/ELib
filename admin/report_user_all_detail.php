...
switch ($id) {
    case "1":
        $title='Detail Report of All Visitors';
        $columntitle='Visitor';
                  ...
                  <div class="row">
                    <div class="col-sm-2">
                        <div class="form-group">
                            <a href="?page=Dashboard-Detail-Print&id=7&id2=<?php echo urlencode($id2); ?>&id3=<?php echo urlencode($id3); ?>&id4=<?php echo urlencode($id4); ?>" class="btn btn-info btn-sm"  width="100%" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-file-pdf-o fa-fw"></i>&nbsp;&nbsp;PDF&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a> 
                        </div>
                    </div>        
                  </div> 
