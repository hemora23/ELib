            ...
            $("#datatable-buttons").DataTable({
              ...
              buttons: [
                ...
                },
                {
                  extend: "print",
                  className: "btn-sm",
                  title: "<?php echo $_SESSION['SES_TITLE']; ?>",
                  message: "",
		...
		dom: "lfrtip<'clear'>B",
              buttons: [
                ...
                
                {
                  ...
                  className: "btn-sm",
                  title: "<?php echo $_SESSION['SES_TITLE']; ?>",
                  message: "<?php echo $_SESSION['SES_SUBTITLE']; ?>",
                  customize: function ( win ) {
                        $(win.document.body)
                            .css( 'font-size', '8pt' )
                            .prepend(
                                '<img src="http://202.154.3.188/KMS/uploads/logo.png" width="200px" style="position:absolute; top:0; left:0;" />'
                            );
    ...
    $('#datatable-responsive-e').DataTable({dom: "",responsive: true});
