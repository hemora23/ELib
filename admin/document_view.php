      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content ">
            ...
            <div class="col-xs-6">
              <div class="form-group">
                <label>Review Note </label><br /><?php echo $dataNote; ?>&nbsp;
              </div>
            </div>
            ...
            <div class="col-xs-12">
                  ...
                  <tbody>
                    ...
                    ?>
                      ...
                      <tr>
                        ...
                        <td width="5%"><?php echo $myData['updated_by']; ?></td>
                        <td width="5%"><?php echo $myData['updated_date']; ?></td>
                      </tr>
                    <?php } ?>
                  </tbody>
                </table>
              ...
              <p><b>Document Privileges</b></p>
              <div class="x_content col-xs-12">
                <table id="datatable-responsive-d" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                  <thead>
                    <tr>
                      <th>No</th>
                      <th>Division</th>
              ...
              <p><b>File Privileges</b></p>
              <div class="x_content col-xs-12">
                <table id="datatable-responsive-e" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                  <thead>
                    <tr>
                      <th>No</th>
                      <th>File</th>
