<?php
$_SESSION['SES_TITLE'] = "Document";
include_once "library/inc.seslogin.php";
include "header.php";
$_SESSION['SES_PAGE'] = "?page=Document";
?>
    ...
    <div class="page-title">
      ...
      <div class="title_right">
        <div class="form-group pull-right">
          <a href="?page=Document-Add" class="btn btn-primary btn-sm" role="button"><i class="fa fa-plus-square fa-fw"></i> Add New Data</a>
        </div>
      </div>
    </div>
          ...
          <div class="x-content">
            <form role="form" action="?page=Filter" method="POST" name="form1" target="_self" id="form1">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  while ($row = mysqli_fetch_array($result)) {
                    ...
                    $space = "";
                    if ($row['category_level_2'] != '') {
                      $dataCategory2 = '| ' . $row['category_level_2'];
                    } else {
                      $dataCategory2 = '';
                    };
                    if ($row['category_level_3'] != '') {
                      $dataCategory3 = '| ' . $row['category_level_3'];
                    } else {
                      $dataCategory3 = '';
                    };
                    if ($row['category_level_4'] != '') {
                      $dataCategory4 = '| ' . $row['category_level_4'];
                    } else {
                      $dataCategory4 = '';
                    };
                    if ($row['category_level_5'] != '') {
                      $dataCategory5 = '| ' . $row['category_level_5'];
                    } else {
                      $dataCategory5 = '';
                    };
                    if ($row['category_level_6'] != '') {
                      $dataCategory6 = '| ' . $row['category_level_6'];
                    } else {
                      $dataCategory6 = '';
                    };
              ...
              <div class="col-sm-2">
                <div class="form-group">
                  <label>&nbsp;</label><br />
                  <button type="submit" class="btn btn-primary btn-sm" name="btnDocument01" style="width:100%"><i class="fa fa-filter fa-fw"></i> Filter</button>
                </div>
              </div>
            </form>
          ...
          <div class="x_content table-responsive">
            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive" cellspacing="0" width="100%">
              ...
              <tbody>
                ...
                $st  = isset($_GET['st']) ?  $_GET['st'] : '%';
                $mySql   = "SELECT v.* FROM view_document v where v.document_status 
like '$st'  and v.category_id like '$id' and (v.document_version = (select max(w.document_version) from view_document w where w.document_id=v.document_id) or  v.document_status='Approved') order  by v.updated_date desc
...
";
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <!-- <td>
                                             <?php if ($myData['document_status'] == 'Approved') { ?>
                                             <a href="?page=Document-Link-Add&id=<?php echo $Code; ?>&v=<?php echo $Version; ?>" target="_self" alt="Edit Data"><i class="fa fa-link fa-fw"></i> Link</a>
                                            <?php } ?>
                                            </td> -->
                    <td>
                      <?php if ($myData['document_status'] != 'Reviewed') { ?>
